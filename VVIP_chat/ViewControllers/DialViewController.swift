...
class DialViewController: UIViewController {
    ...
    @IBOutlet weak var addNo: UILabel!
    ...
    private func dialConfig(){
        ...
        let addNoGstr = UITapGestureRecognizer(target: self, action:  #selector(self.addNoPressed))
        ...
        addNo.addGestureRecognizer(addNoGstr)
    }
    ...
    @objc func addNoPressed(sender : UITapGestureRecognizer) {
        print("add No tapped")
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "DialServerIDViewController") as! DialServerIDViewController
