...
class EditProfileViewController: UIViewController, UITextFieldDelegate {
    ...
    private func txtFieldConfig(){
        ...
        placeholderText(field: titleField, text: "Enter Title")
        placeholderText(field: designtionField, text: "Enter designation")
        placeholderText(field: firstNameField, text: "Enter first name")
        placeholderText(field: lastNameField, text: "Enter last name")
        placeholderText(field: emailField, text: "Enter email")
        placeholderText(field: countryField, text: "Enter country")
        placeholderText(field: stateField, text: "Enter state")
        placeholderText(field: cityField, text: "Enter city")
        placeholderText(field: zipField, text: "Enter zip")
    }
