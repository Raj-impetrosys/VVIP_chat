    ...
    private func rightMenuConfig(){
        var menuItems: [UIAction] {
            return [
                ...
                UIAction(title: "New Group", image: UIImage(systemName: "bubble.left.and.bubble.right"), handler: { (_) in
                }),
                UIAction(title: "New Broadcast", image: UIImage(systemName: "ellipsis.bubble"), handler: { (_) in
                }),
                UIAction(title: "Setting", image: UIImage(systemName: "gearshape"), handler: { (_) in
                }),
            ]
        }
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Menu", image: UIImage(named:"more-20"), primaryAction: nil, menu: demoMenu)
    }
