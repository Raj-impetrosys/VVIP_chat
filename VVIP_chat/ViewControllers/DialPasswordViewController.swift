//
//  DialPasswordViewController.swift
//  VVIP_chat
//
...
class DialPasswordViewController: UIViewController {
    @IBOutlet weak var dialScreenLbl: UITextField!
    ...
    private func dialConfig(){
        ...
        let enterPwdGstr = UITapGestureRecognizer(target: self, action:  #selector(self.enterPwdPressed))
        ...
        enterPassword.addGestureRecognizer(enterPwdGstr)
    }
