...
class AppearenceViewController: UIViewController, PHPickerViewControllerDelegate {
...
//        print("assetIdentifier: \(result.itemProvider)")
        ...
        if provider.hasItemConformingToTypeIdentifier(UTType.movie.identifier) {
                                provider.loadItem(forTypeIdentifier: UTType.movie.identifier, options: [:]) {
                                    (videoURL, error) in
