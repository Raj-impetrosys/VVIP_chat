...
class DialPinViewController: UIViewController {
    ...
    @IBOutlet weak var enterPIN: UILabel!
    ...
    private func dialConfig(){
        ...
        let enterPINGstr = UITapGestureRecognizer(target: self, action:  #selector(self.enterPINPressed))
        ...
        enterPIN.addGestureRecognizer(enterPINGstr)
    }
    ...
    @objc func enterPINPressed(sender : UITapGestureRecognizer) {
        print("Enter PIN tapped")
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "DialPlayerCodeViewController") as! DialPlayerCodeViewController
