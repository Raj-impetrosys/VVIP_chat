//
//  DialPlayerCodeViewController.swift
//  VVIP_chat
//
...
class DialPlayerCodeViewController: UIViewController {
    ...
    @IBOutlet weak var enterPlayerCode: UILabel!
    ...
    private func dialConfig(){
        ...
        let enterPlayerCodeGstr = UITapGestureRecognizer(target: self, action:  #selector(self.enterPlayerCodePressed))
        ...
        enterPlayerCode.addGestureRecognizer(enterPlayerCodeGstr)
    }
    ...
    @objc func enterPlayerCodePressed(sender : UITapGestureRecognizer) {
        print("Enter Player Code tapped")
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "SetPhotoVideoViewController") as! SetPhotoVideoViewController
        if(!dialScreenLbl.text!.isEmpty){
            self.navigationController?.pushViewController(vc, animated: true)
        } else {
            let alert = UIAlertController(title: "Alert",
                                          message: "Please Enter Player Code",
